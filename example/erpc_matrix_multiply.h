...
/*
 * Generated by erpcgen 1.9.1 on Sat Feb 11 14:19:01 2023.
 *
 ...
 */
class MatrixMultiplyServiceClient : public erpc::Client
{
public:
    MatrixMultiplyServiceClient(const char *host, uint16_t port, erpc::MessageBufferFactory *messageFactory) : erpc::Client(host, port, messageFactory) {}
    ~MatrixMultiplyServiceClient(){}
    /*! @brief Client shim for erpcMatrixMultiply of MatrixMultiplyService interface. */
    void erpcMatrixMultiply(Matrix matrix1, Matrix matrix2, Matrix result_matrix);

    /*! @brief Client shim for erpctest of MatrixMultiplyService interface. */
